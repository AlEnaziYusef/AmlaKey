...
const styles = (C: any, shadow: any) => StyleSheet.create({
  ...
  modalSheet: { backgroundColor: C.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: spacing.lg, paddingBottom: Platform.OS === "ios" ? 40 : spacing.lg, maxHeight: "88%" },
  ...
  input: { backgroundColor: C.surfaceElevated, borderRadius: radii.sm, borderWidth: 1, borderColor: C.border, paddingHorizontal: 14, paddingVertical: 12, color: C.text, fontSize: 15 },
  dateBtn: { backgroundColor: C.surfaceElevated, borderRadius: radii.sm, borderWidth: 1, borderColor: C.border, paddingHorizontal: 14, paddingVertical: 12 },
